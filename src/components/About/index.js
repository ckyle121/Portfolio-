  ...
  return(
    ...
    <h2 class="display-4">About Me</h2>
      <div class="row justify-content-center">
          <p class="col-md-4 col-sm-12 bio-text">
            ...
            well as data analytics. At the bottom of the website is my contact information, please feel free to reach out about any
            inquiries you may have about these projects. Enjoy!
          </p>
