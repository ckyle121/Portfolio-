  ...
  const [projects] = useState([
    {
      ...
      pic: dreamTeamPic,
      languages: 'BackEnd Application - Node.js, Inquirer'
    },
    {
      name: 'WatchSocial', 
      ...
      pic: watchSocialPic,
      languages: 'FullStack Application - Handlebars, Express, MySQL'
    },
    {
      name: 'Beers & Bros', 
      ...
      description: 'This application is a CMS-style website where users can review movies and enjoy an unfiltered, non-critic, review of other users using the website.',
      pic: beerBrosPic,
      languages: 'FrontEnd Application - JavaScript, REST APIs'
    },
    {
      name: 'Notepad', 
      ...
      pic: notePadPic,
      languages: 'BackEnd Application - Node, Express, UUID'
    },
    {
      ...
      pic: socialMediaPic,
      languages: 'BackEnd Application - MongoDB, CRUD API Routes'
    },
  ]);
